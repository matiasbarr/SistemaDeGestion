...
public class ProveedorModificarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            int idProveedor = Integer.parseInt(request.getParameter("hdn_id_proveedor"));
            ...
            Proveedor prov = proveedorFacade.find(idProveedor);
            
            prov.setRazonSocial(razonSocial);
            prov.setDireccionProveedor(direccionProveedor);
            prov.setCorreoProveedor(correoProveedor);
            prov.setTelefonoProveedor(telefonoProveedor);
            prov.setDescripcionProveedor(descripcionProveedor);
            prov.setGiro(giro);
            
            proveedorFacade.edit(prov);
