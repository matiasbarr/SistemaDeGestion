...
public class TipoOrigenVentaModificarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            int idtipoorigenventa = Integer.parseInt(request.getParameter("hdn_tipo_origen_venta"));
            String tipoorigen = request.getParameter("txt_tipo_origen_venta");
            
            TipoOrigenVenta oriven = tipoOrigenVentaFacade.find(idtipoorigenventa);
            oriven.setTipoOrigen(tipoorigen);
            tipoOrigenVentaFacade.edit(oriven);
