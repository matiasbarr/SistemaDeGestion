 ...
 * @author john-
 */
public class TipoEstadoAgregarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String tipoEstadoo = request.getParameter("txt_tipo_estado");
            
            TipoEstado tipoEstado = new TipoEstado();
            
            tipoEstado.setTipoEstado(tipoEstadoo);
            //insertar objeto en base de datos
             tipoEstadoFacade.create(tipoEstado);
